...
#         cur = conn.cursor()
#         cur.execute("select * from display where name=?", (username,))
#         data = cur.fetchall()
...
#         conn=sql.connect("user.db")
#         cur=conn.cursor()
#         cur.execute("update display set name=?,fund_house1=?,invested_amount=?,unit_held=?,nav=?,current_value=?,growth=? where Id=?",(name,fund_house1,invested_amount,unit_held,nav,current_value,growth,id))
#         conn.commit()
#         flash("User Updated","success")
#         redirect(url_for('home1'))
#     conn=sql.connect("user.db")
#     conn.row_factory=sql.Row
#     cur=conn.cursor()
...
#         conn.row_factory=sql.Row
#         cur=conn.cursor()
#         cur.execute("Select * from signup where name=? and password=?",(name,password))
#         data=cur.fetchall()
#         if data:
